...
const Home = () => {
    ...
    return (
        <main className="w-full h-screen flex flex-col justify-around  p-4 snap-mandatory snap-y overflow-scroll scroll-smooth">
            ...
            <section className='w-full h-svh '>
                <div className='w-full h-screen flex flex-col justify-center gap-10  snap-center'>
                    ...
                    <div className='w-full flex justify-center content-evenly'>
                        <div className='w-[400px] h-[238px] relative '>
                            <div className='w-[142px] h-[90px] absolute top-0 left-0 bg-gray-200'></div>
                            <div className='w-[124px] h-[205px] absolute top-0 right-0 bg-gray-200'></div>
                            <div className='w-[114px] h-[130px] absolute bottom-0 left-10 bg-gray-200'></div>
