    ...
    return (
        <nav >
            <div className="w-full h-fit fixed top-0 flex flex-row justify-around items-center  py-3 bg-white">
                <NavLink to="https://calendly.com/loqueveo/30min" target="_blank" rel="noopener noreferrer" className="uppercase text-md sm:text-sm lg:text-xl hover:font-semibold">UN SHOOTING O Q???</NavLink>
                {
                ...
                <NavLink to="https://www.instagram.com/loqueveooo/?hl=en" target="_blank" rel="noopener noreferrer" className="uppercase text-md sm:text-sm lg:text-xl hover:font-semibold">sígueme</NavLink>
            </div >
        </nav>
    )
}
