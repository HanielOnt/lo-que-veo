            ...
            <div className='w-full h-fit mt-[3rem] flex-flex-col justify-center px-6 py-2 lg:mt-20  '>
                ...
                <div className='w-fit h-fit flex flex-row justify-center items-start gap-4 sm:flex-col md:items-evenly lg:mt-4 '>
                    ...
                    <div className='w-1/2 h-fit text-pretty sm:w-full lg:px-4 '>
                        ...
                        <p className='p-text lg:text-lg lg:leading-1'>Es el viaje de nunca perder de vista la maravilla de cada ser humano y cada rincón que tengo el privilegio de encontrar. La oportunidad de recordarles que ellos importan, que su historia importa y que poseer nuestra historia es lo más valiente que podemos hacer.</p>

                        <p className='p-text lg:text-lg lg:leading-1'>Lo que veo es una aventura más allá de mi imaginación más salvaje, confiando en que cada capítulo de mi historia trabajará en conjunto para el bien de los demás.</p>
                        <p className='p-text lg:text-lg lg:leading-1'>No tengo como compartir todas las caras lindas que he visto y que me han dado ratos riquísimos de compañía y conversación. Muchas que me faltan por fotografiar, muchas que quiero seguir retratando, muchas que ya no están cerca y me dieron para toda mi vida.</p>
                    </div>
                </div>
